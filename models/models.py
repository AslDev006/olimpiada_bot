...
class User(models.Model):
    ...
    # olimp_math_score = models.IntegerField(null=True, blank=True)
    # olimp_physic_score = models.IntegerField(null=True, blank=True)
    # olimp_computer_score = models.IntegerField(null=True, blank=True)
    # olimp_total_score = models.IntegerField(null=True, blank=True, validators=[MinValueValidator(0),
